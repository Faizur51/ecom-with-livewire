        ...
        <div class="categori-dropdown-wrap categori-dropdown-active-large" style="z-index: 999">
            <ul>
                ...
                <li class="{{count($category->subcategory) > 0 ? 'has-children':''}}">
                    <a href="shop.html"><i class="surfsidemedia-font-tshirt"></i>{{ucwords($category->name)}}</a>
                                ...
                                <ul class="d-lg-flex">
                                    <li class="mega-menu-col col-lg-9">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item nav-link nav_item" href="#">{{ucwords($scategory->name)}}</a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                </ul>
