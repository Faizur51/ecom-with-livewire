                    ...
                    <div class="categori-dropdown-wrap categori-dropdown-active-small">
                        <ul>
                            @foreach($categories as $category)
                                <li><a href="{{route('category.product',['slug'=>$category->slug])}}"><i class="surfsidemedia-font-dress"></i>{{ucwords($category->name)}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <nav>
                    <ul class="mobile-menu">
                        ...
                        <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Our Collections</a>
                            <ul class="dropdown">
                                @foreach($categories as $category)
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">{{ucwords($category->name)}}</a>
                                        <ul class="dropdown">
                        ...
                        <li class="menu-item-has-children"><span class="menu-expand"></span><a href="javascript:void(0)">Blog</a></li>
