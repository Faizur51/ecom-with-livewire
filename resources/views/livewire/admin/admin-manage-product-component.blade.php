                                                                ...
                                                                <td>
                                                                    <div class="product-img product-img-zoom img-hover-scale overflow-hidden">
                                                                        @if(strlen($product->image > 25))
                                                                            <a href="{{route('product.details',['slug'=>$product->slug])}}"><img class="default-img" src="{{$product->image}}" alt="" style="width: 80px;height: 50px"></a>
                                                                        @else
                                                                            <a href="{{route('product.details',['slug'=>$product->slug])}}"><img class="default-img" src="{{asset('frontend/assets/images/product')}}/{{$product->image}}" alt="" style="width: 80px;height: 50px"></a>
                                                                        @endif
                                                                    </div>

                                                                </td>
                                                                <td>
                                                                    <p class="text-center {{$product->status==1?'bg-3':'bg-6'}}">
                                                                        <a href="javascript:void(0)">{{$product->status==1?'Active':'Inactive'}}</a>
                                                                    </p>
                                                                </td>
