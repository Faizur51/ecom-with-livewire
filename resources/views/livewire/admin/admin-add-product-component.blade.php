                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="contact-form-style mb-1">
                                            ...
                                            <div class="input-style mb-2">
                                                @foreach($sizes as $size)
                                                    <div class="icheck-material-grey icheck-inline">
                                                        <input type="checkbox" id="{{$size->name}}1"
                                                               value="{{$size->name}}" wire:model="size"/>
                                                        <label for="{{$size->name}}1">{{ucwords($size->name)}}</label>
                                                    </div>
                                                @endforeach
                                            ...
                                            <div class="input-style mb-2">
                                                @foreach($colors as $color)
                                                    <div class="icheck-material-{{$color->name}} icheck-inline">
                                                        <input type="checkbox" id="{{$color->name}}1"
                                                               value="{{$color->name}}" wire:model="color"/>
                                                        <label for="{{$color->name}}1">{{ucwords($color->name)}}</label>
                                                    </div>
                                                @endforeach
                                                @error('color') <p class="text-danger">{{$message}}</p> @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <label for="inputPassword" class="col-sm-3 col-form-label">Galary
                                                Images</label>
                                            <div class="input-style mb-2">
                                                <input placeholder="Image" type="file" class="form-control" multiple wire:model="images">
                                                @if($images)
                                                    @foreach($images as $image)
                                                        <img src="{{$image->temporaryUrl()}}"
                                                             style="width: 77px;height: 70px" alt="">
                                                    @endforeach
                                                @endif
