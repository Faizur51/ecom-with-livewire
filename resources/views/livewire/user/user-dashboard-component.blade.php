                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                                 <div class="col-md-3 editimage">
                                                                       ...
                                                                       @else
                                                                           <img src="{{asset('frontend/assets/images/profile/user/images30.png')}}" alt="">
                                                                       @endif
                                                                     <div class="topleft">
                                                             ...
                                                             <div class="col-md-3">
                                                                 <p>Full Name : {{ucwords($user->name)}}</p>
                                                                 <p>Email     : {{$user->email}}</p>
                                                                 <p>Phone No  : {{$user->profile->phone}}</p>
                                                                 <p>Gender    : {{ucwords($user->profile->gender)}}</p>
                                                                 <p>Birth Date: {{$user->profile->birth_date}}</p>
                                                                 <p>Occupation: {{ucwords($user->profile->occupation)}}</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" style="width: 100%" wire:click.prevent="UpdateProfile()">Update Profile</button>
                </div>
            </div>
        </div>
    </div>
